...
class VnGranPalataFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.gran_palata_vn1,
        R.drawable.gran_palata_vn2,
        R.drawable.gran_palata_vn3,
        R.drawable.gran_palata_vn4,
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_vn_gran_palata, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkTextViewGranPalata)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "rCXDAWN2VUIzOvV1zZo2",
        ...
        db.collection("landmarks").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Владычная грановитая палата") as? String
