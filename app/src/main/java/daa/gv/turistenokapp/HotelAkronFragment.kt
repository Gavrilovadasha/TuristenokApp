...
class HotelAkronFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.hotel_akron1,
        R.drawable.hotel_akron2,
        R.drawable.hotel_akron3,
        R.drawable.hotel_akron4,
        R.drawable.hotel_akron5,
        R.drawable.hotel_akron6,
        R.drawable.hotel_akron7
        )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_hotel_akron, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkAkron)
        siteLinkTextView = view.findViewById(R.id.siteLink)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "kY1KkDQ0DSpnNs6shTpR",
        ...
        db.collection("hotels").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Отель Акрон") as? String
