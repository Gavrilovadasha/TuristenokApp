...
class GostVolxovFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.hotel_volxov1,
        R.drawable.hotel_volxov2,
        R.drawable.hotel_volxov3,
        R.drawable.hotel_volxov4,
        R.drawable.hotel_volxov5,
        R.drawable.hotel_volxov6
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_gost_volxov, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkVolxov)
        siteLinkTextView = view.findViewById(R.id.siteLinkVolxov)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "wBFWXF0pBwZfKyy8MHOu",
        ...
        db.collection("hotels").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Гостиница Волхов") as? String
