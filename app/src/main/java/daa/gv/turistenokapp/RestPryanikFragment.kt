...
class RestPryanikFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.rest_pryanik1,
        R.drawable.rest_pryanik2,
        R.drawable.rest_pryanik3,
        R.drawable.rest_pryanik4,
        R.drawable.rest_pryanik5,
        R.drawable.rest_pryanik6
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_rest_pryanik, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkRestPryanik)
        siteLinkTextView = view.findViewById(R.id.siteLinkRestPryanik)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "0H3rgSTOjttp45aQy88P",
        ...
        db.collection("restaurant").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Ресторан Пряник") as? String
