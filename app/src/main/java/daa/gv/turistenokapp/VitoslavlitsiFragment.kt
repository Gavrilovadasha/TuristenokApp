...
class VitoslavlitsiFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.nov_vitosl4,
        R.drawable.nov_vitosl3,
        R.drawable.nov_vitosl2
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_vitoslavlitsi, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkVitoslitsi)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "S3GEkjGgcv9AaeU1iYcN",
        ...
        db.collection("landmarks").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Витославлицы") as? String
