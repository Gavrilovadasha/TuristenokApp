...
class HotelRachmaninovFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.hotel_raxm1,
        R.drawable.hotel_raxm3,
        R.drawable.hotel_raxm4,
        R.drawable.hotel_raxm5,
        R.drawable.hotel_raxm6
        )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_hotel_rachmaninov, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkRachmaninov)
        siteLinkTextView = view.findViewById(R.id.siteLinkRachmaninov)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "R0oFsEDPDX3N3qaTiMN6",
        ...
        db.collection("hotels").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Отель Рахманинов") as? String
