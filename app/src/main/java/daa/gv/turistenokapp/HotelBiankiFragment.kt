...
class HotelBiankiFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.hotel_bianki1,
        R.drawable.hotel_bianki2,
        R.drawable.hotel_bianki3,
        R.drawable.hotel_bianki4
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_hotel_bianki, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkBianki)
        siteLinkTextView = view.findViewById(R.id.siteLinkBianki)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "wrhNgd3jeDyDmw4IhPJ0",
        ...
        db.collection("hotels").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Отель Бианки") as? String
