...
class HotelKarelinnFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.hotel_karelinn4,
        R.drawable.hotel_karelinn2,
        R.drawable.hotel_karelinn3,
        R.drawable.hotel_karelinn5
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_hotel_karelinn, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkRossia)
        siteLinkTextView = view.findViewById(R.id.siteLinkRossia)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "AI23fasUg7kEFPKK6cQ4",
        ...
        db.collection("hotels").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Отель Карелинн") as? String
