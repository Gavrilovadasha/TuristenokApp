...
class RestSkazkaFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.chaixona_skazka1,
        R.drawable.chaixona_skazka2,
        R.drawable.chaixona_skazka3,
        R.drawable.chaixona_skazka6,
        R.drawable.chaixona_skazka5,
        R.drawable.chaixona_skazka4
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_rest_skazka, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkRestSkazka)
        siteLinkTextView = view.findViewById(R.id.siteLinkRestSkazka)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "xYGfl4oYY5yrUThyuva9",
        ...
        db.collection("restaurant").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Чайхана сказка") as? String
