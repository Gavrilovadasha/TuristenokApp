...
class LadogaNikolsMonasFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.nikolsk_movast_st_ladoga1,
        R.drawable.nikolsk_movast_st_ladoga2,
        R.drawable.nikolsk_movast_st_ladoga3,
        R.drawable.nikolsk_movast_st_ladoga4,
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_ladoga_nikols_monas, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkTextViewLadogaNikMonast)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "3wlUxMwQv8fva8E2B2zR",
        ...
        db.collection("landmarks").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Никольский мужской монастырь") as? String
