...
class RestGeogrFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.rest_geogr1,
        R.drawable.rest_geogr2,
        R.drawable.rest_geogr3,
        R.drawable.rest_geogr6,
        R.drawable.rest_geogr5,
        R.drawable.rest_geogr4
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_rest_geogr, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkRestGeogr)
        siteLinkTextView = view.findViewById(R.id.siteLinkRestGeogr)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "1r9gTOoucXqs9c3vTOJF",
        ...
        db.collection("restaurant").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Ресторан География") as? String
