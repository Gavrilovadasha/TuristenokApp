...
class RostovKremlinFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.rost_kremlin1,
        R.drawable.rost_kremlin2,
        R.drawable.rost_kremlin3,
        R.drawable.rost_kremlin4
        )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_rostov_kremlin, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkTextViewKremlinRost)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "JzwAylke0OV5LDYHXzzh",
        ...
        db.collection("landmarks").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Ростовский Кремль") as? String
