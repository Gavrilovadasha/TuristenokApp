...
class TorgFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.nov_torg1,
        R.drawable.nov_torg3,
        R.drawable.nov_torg2
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_torg, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkTorg)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "pxReg22dOWbJ6ljIwIt4",
        ...
        db.collection("landmarks").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Торг и Ярославово дворище") as? String
