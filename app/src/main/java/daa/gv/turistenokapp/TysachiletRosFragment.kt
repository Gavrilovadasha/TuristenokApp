...
class TysachiletRosFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.nov_tysach,
        R.drawable.nov_tysach2,
        R.drawable.nov_tysach3
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_tysachilet_ros, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkTysRos)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "ndkvnI9tUJWOqiv02fvQ",
        ...
        db.collection("landmarks").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Памятник Тысячелетия России") as? String
