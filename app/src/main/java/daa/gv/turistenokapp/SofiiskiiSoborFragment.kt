...
class SofiiskiiSoborFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.nov_sofiiskii4,
        R.drawable.nov_sofiiskii5,
        R.drawable.nov_sofiiskii2,
        R.drawable.nov_sofiiskii3
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_sofiiskii_sobor, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkSofiiskiy)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "SCtup04YtHJW93m0hvzq",
        ...
        db.collection("landmarks").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Софийский собор") as? String
