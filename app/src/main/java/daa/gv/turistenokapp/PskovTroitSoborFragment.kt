...
class PskovTroitSoborFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.svyat_sobor_pskov1,
        R.drawable.svyat_sobor_pskov,
        R.drawable.svyat_sobor_pskov4
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_pskov_troit_sobor, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkTextViewPskovTroitSobor)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "EFgGd0F3Ta027N0jrHrn",
        ...
        db.collection("landmarks").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Свято-Троицкий кафедральный собор") as? String
