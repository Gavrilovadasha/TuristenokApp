...
class RestaurantFragment : Fragment(R.layout.fragment_restaurant) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkRest)
        siteLinkTextView = view.findViewById(R.id.siteLinkRest)
        ...
        if (documentId != null) {
            Log.d("RestaurantFragment", "Received landmark_id: $documentId")
            loadRestData(documentId)
        } else {
            Log.e("RestaurantFragment", "landmark_id is null or not provided")
            Toast.makeText(
                requireContext(),
        ...
        db.collection("restaurant").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    view?.findViewById<TextView>(R.id.nameLandmark)?.text =
                    ...
                    val restaurantName = document.getString("name") // Название ресторана
                    mapUrl = maps?.get(restaurantName) as? String
                    if (!mapUrl.isNullOrEmpty()) {
                    ...
                    siteUrl = site?.get(restaurantName) as? String
    ...
    companion object {
        fun newInstance(documentId: String): RestaurantFragment {
