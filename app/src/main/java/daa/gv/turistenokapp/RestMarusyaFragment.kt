...
class RestMarusyaFragment : Fragment() {
    ...
    private val images = listOf(
        R.drawable.rest_marusya1,
        R.drawable.rest_marusya2,
        R.drawable.rest_marusya3,
        R.drawable.rest_marusya4,
        R.drawable.rest_marusya5,
        R.drawable.rest_marusya6
        )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_rest_marusya, container, false)
        ...
        mapLinkTextView = view.findViewById(R.id.mapLinkRestMarusya)
        siteLinkTextView = view.findViewById(R.id.siteLinkRestMarusya)

        // Загрузка данных для достопримечательности
        loadLandmarkData(
            db = FirebaseFirestore.getInstance(),
            documentId = "pBLRFCg25zfDx0oPSkSK",
        ...
        db.collection("restaurant").document(documentId)
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    mapUrl = maps?.get("Ресторан Маруся") as? String
